...
const services: Service[] = [
  {
    ...
    title: "Quét 3D",
    description:
      "Dịch vụ quét 3D chuyên nghiệp với độ chính xác cao, phù hợp cho mọi kích thước và độ phức tạp.",
  ...
  },
  {
    ...
    description:
      "Chuyển đổi dữ liệu quét 3D thành mô hình CAD có thể chỉnh sửa cho mục đích sản xuất.",
  ...
  },
  {
    ...
    description:
      "Kiểm tra kích thước và so sánh với CAD để đảm bảo chất lượng sản phẩm theo tiêu chuẩn.",
  ...
  },
  {
    ...
    title: "Đào tạo",
    description:
      "Đào tạo chuyên sâu về công nghệ quét 3D và các phần mềm liên quan cho doanh nghiệp.",
  ...
  },
  {
    ...
    description:
      "Số hóa và lưu trữ các di tích lịch sử, tác phẩm nghệ thuật với độ chính xác tuyệt đối.",
  ...
  },
  {
    ...
    description:
      "Dịch vụ bảo trì, cập nhật và hỗ trợ kỹ thuật 24/7 cho khách hàng.",
  ...
  >
    ...
    <div className="absolute inset-0 p-6 flex flex-col">
      ...
      <div className="transform transition-transform duration-500 ease-out group-hover:-translate-y-4">
        ...
        <p className="text-white mb-4 line-clamp-2 opacity-0 transition-all duration-500 group-hover:opacity-100">
          {service.description}
        </p>
    ...
    >
      ...
      <div className="container">
        <div className="max-w-2xl mx-auto text-center mb-12">
          <h2 id="services-heading" className="text-4xl font-bold mb-2">
            DỊCH VỤ CỦA CHÚNG TÔI
          </h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
          <p className="text-lg">
            Cung cấp đầy đủ các dịch vụ quét 3D và giải pháp số hóa chuyên
            nghiệp
          </p>
        </div>
